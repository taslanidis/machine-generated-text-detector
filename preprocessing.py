...
def main():
    ...
    parser.add_argument("--dataset", type=str, default="followupqg", help="Dataset name")
    parser.add_argument("--batch_size", type=int, default=32, help="Batch size for evaluation.")
    parser.add_argument("--seed", type=int, default=42, help="Random seed for reproducibility.")
    parser.add_argument("--data_type", type=str, default="json_qa", help="Data type")
    args = parser.parse_args()

    # pre-processing
    if args.dataset == 'followupqg':

        FollowupqgDataset.process(model=args.model,
        ...
        GenerativeDataset.process(model=args.model,
                                  dataset=args.dataset,
                                  batch_size=args.batch_size,
                                  max_length=160,
                                  seed=args.seed)
